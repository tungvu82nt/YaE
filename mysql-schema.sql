...
-- ===========================================
-- 8. CREATE USER AND GRANT PERMISSIONS
-- ===========================================
-- Note: Run these commands separately as root/admin user
/*
...
SELECT '📊 Database: yapee_db' as database_name;
SELECT '👤 User: yapee_user' as database_user;
SELECT '🔐 Password: password123' as database_password;
